...
<script>
    ...
    const nickname_check = () => {
        const typingNickname = document.getElementById("user-nickname").value;
        ...
        $.ajax({
            ...
            success: function (res) {
                nickname_bottom.innerHTML = "고객님의 이메일은 "+res+"입니다";
            },
            error: function () {
                nickname_bottom.innerHTML = "고객님의 이메일을 찾을 수 없습니다";
            }
        })
    }
</script>
